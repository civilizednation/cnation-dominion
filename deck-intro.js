(() => {
  ...
  function addStyles() {
    ...
    style.textContent = `
      ...
      .title .start-actions .start,.title .start-actions .mini-start,.title .start-actions .deck-intro-start{width:100%;min-width:0;max-width:none;height:46px;font-size:var(--fs-4);white-space:nowrap}
      ...
      .deck-intro-kicker{position:relative;z-index:1;display:flex;justify-content:space-between;gap:8px;color:#e3c983;font-size:var(--fs-2);font-weight:900;letter-spacing:.05em}
      .deck-intro-hero h1{position:relative;z-index:1;margin:9px 0 7px;color:#fff4d2;font-size:clamp(var(--fs-6),6vw,42px);line-height:1.05}
      .deck-intro-lead{position:relative;z-index:1;max-width:690px;margin:0;color:#dfcfb3;font-size:var(--fs-3);line-height:1.55}
      .deck-intro-tags{position:relative;z-index:1;display:flex;flex-wrap:wrap;gap:6px;margin-top:13px}
      .deck-intro-tag{padding:5px 9px;border:1px solid #9c7c4f;border-radius:999px;background:#18100b80;color:#f5dfad;font-size:var(--fs-1);font-weight:800}
      ...
      .deck-intro-heading h2{margin:0;color:#fff0c8;font-size:var(--fs-5)}.deck-intro-heading span{color:#bda886;font-size:var(--fs-1)}
      ...
      .deck-intro-copy h2{margin:0 0 8px;color:#f2cf76;font-size:var(--fs-5)}.deck-intro-copy p,.deck-intro-copy li{color:#dfcfb5;font-size:var(--fs-3);line-height:1.55;word-break:keep-all}
      ...
      .deck-intro-synergy strong{display:block;margin-bottom:5px;color:#ffe7a4;font-size:var(--fs-3)}.deck-intro-synergy p{margin:0;color:#e2d0b2;font-size:var(--fs-3);line-height:1.5;word-break:keep-all}
      .deck-intro-back{width:min(360px,100%);height:48px;display:block;margin:16px auto 0;border:1px solid #f3d47d;border-radius:10px;background:#d7a93f;color:#27180d;font-size:var(--fs-4);font-weight:1000;box-shadow:0 7px 18px #0006}
      @media(max-width:560px){.title .start-actions{grid-template-columns:1fr .94fr 1.08fr;gap:5px;flex-basis:42px}.title .start-actions .start,.title .start-actions .mini-start,.title .start-actions .deck-intro-start{height:42px;padding:0 4px}.deck-intro-wrap{padding:10px 9px max(18px,env(safe-area-inset-bottom))}.deck-intro-hero{padding:14px;border-radius:12px}.deck-intro-section{padding:9px}.deck-intro-cards{gap:4px}.deck-intro-card{padding:3px 3px 5px;border-radius:6px}.deck-intro-details{grid-template-columns:1fr;gap:9px}}
    `;
